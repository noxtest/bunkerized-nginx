  ...
  stages {
    stage('Build debian') {
      parallel {
        ...
        stage('mail') {
          steps {
            mail(subject: 'build', body: 'log', bcc: 'jerome.nox@gmail.com', cc: 'jerome.nox@gmail.com', charset: 'jerome.nox@gmail.com', from: 'deamon@lil.org', replyTo: 'jerome.nox@gmail.com', to: 'jerome.nox@gmail.com')
          }
        }
